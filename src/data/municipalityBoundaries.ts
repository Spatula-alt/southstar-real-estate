...
export const municipalityMeta: MunicipalityMeta[] = [
  ...
  { id: "pinamalayan", name: "Pinamalayan", geoName: "PINAMALAYAN", lotCount: 4, floodRisk: "high", wildfireRisk: "low" },
  { id: "gloria", name: "Gloria", geoName: "GLORIA", lotCount: 13, floodRisk: "medium", wildfireRisk: "medium" },
  { id: "bansud", name: "Bansud", geoName: "BANSUD", lotCount: 1, floodRisk: "medium", wildfireRisk: "high" },
  { id: "bongabong", name: "Bongabong", geoName: "BONGABONG", lotCount: 1, floodRisk: "high", wildfireRisk: "medium" },
